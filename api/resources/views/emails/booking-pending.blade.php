...
@section('content')
  ...
  <p style="margin: 0 0 24px 0; color: #525252; font-size: 14px; line-height: 20px;">
    Votre demande de réservation a bien été reçue. Le professionnel examinera votre demande et vous recevrez une confirmation par email.
  </p>
    ...
    <tr>
      <td style="padding: 16px;">
        <p style="margin: 0; color: #5a431f; font-size: 13px; line-height: 18px;">
          ...
          Vous recevrez un email à <strong>{{ $booking->client_email }}</strong> dès que le professionnel validera votre demande.
        </p>
      </td>
    </tr>
  </table>
